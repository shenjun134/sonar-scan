...
//    	Class clz = Class.forName("" + query.getModelClass().getSimpleName() + "Unmarshaller");
//    	Object obj = clz.newInstance();
//    	if(obj instanceof Unmarshaller){
//    		System.out.println("yes , instans of Unmarshaller");
//    	}
//    	if(Unmarshaller.class.isAssignableFrom(clz)){
//    		System.out.println("yes , is assignable from Unmarshaller");
//    	}
