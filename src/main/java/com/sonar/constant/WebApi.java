...
public interface WebApi {
    ...
    //BLOCKER,CRITICAL
    //http://jabdl3504.it:9113/api/issues/search?facets=authors&severities=&statuses=OPEN,REOPENED&createdAfter=2018-03-06&createdBefore=2018-03-07&componentKeys=com.xxxxxxxxx.gcth:gcth-usecase-remediation-COA20:src/main/java/com/xxxxxxxxx/gcth/coa20/service/impl/MT540PedingDelShareParServiceImpl.java
    ...
    //http://jabdl3504.it:9113/api/sources/lines?key=com.xxxxxxxxx.gcth:gcth-usecase-remediation-COA:src/main/java/com/xxxxxxxxx/gcth/usecase/coa/service/impl/EnrichCartReferenceServiceImpl.java
    ...
    //http://jabdl3504.it.xxxxxxxxx.com:9113/coding_rules#qprofile=java-sonar_ooa_devops-08479|activation=true|types=BUG
    String RULE_LIST = "/coding_rules#qprofile=java-sonar_ooa_devops-08479|activation=true|types=BUG";


    String UT_SEARCH_BY_KEE = "http://jabdl3504.it.xxxxxxxxx.com:9113/api/measures/component?additionalFields=periods&componentKey=#componentKey#&metricKeys=test_success_density,tests,test_failures";

    String UT_SEARCH_BY_ID = "http://jabdl3504.it.xxxxxxxxx.com:9113/api/measures/component?additionalFields=periods&componentId=#componentId#&metricKeys=test_success_density,tests,test_failures";
    ...
    //component tree
    //http://jabdl3504.it.xxxxxxxxx.com:9113/api/measures/component_tree?asc=true&p=12&ps=#pageSize#&metricSortFilter=withMeasuresOnly&p=1&s=metric%2Cname&metricSort=test_success_density&baseComponentKey=com.xxxxxxxxx.gcth:gcth-project-trunk-parent&metricKeys=test_success_density&strategy=leaves

    //overall example
    //http://jabdl3504.it.xxxxxxxxx.com:9113/api/measures/component?metricKeys=line_coverage,new_line_coverage,branch_coverage,new_branch_coverage,overall_uncovered_lines,new_overall_uncovered_lines,uncovered_conditions,new_uncovered_conditions,lines_to_cover,new_lines_to_cover,test_errors,test_failures,skipped_tests,test_success_density,test_execution_time,lines,statements,functions,classes,files,directories&componentKey=com.xxxxxxxxx.gcth:gcth-project-trunk-parent

    String OVER_ALL = "/api/measures/component?metricKeys=#metricKeys#&componentKey=#componentKey#";

    //http://jabdl3504.it.xxxxxxxxx.com:9113/api/measures/component_tree?asc=true&p=1&ps=50&metricSortFilter=withMeasuresOnly&p=1&s=metric%2Cname&metricSort=test_success_density&baseComponentKey=com.xxxxxxxxx.gcth:gcth-project-trunk-parent&metricKeys=test_success_density,test_errors,test_failures&qualifiers=UTS&strategy=all
    ...
    //http://jabdl3504.it.xxxxxxxxx.com:9113/api/metrics/search?ps=9999
